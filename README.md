...
2. Haga clic en conectar y aparecerá un listado con los puertos disponibles para la conección. Si el puerto no aparece pruebe con hacer clic en *mostrar todos los dispositivos conectables*.
